...
public class MedulaActivity extends Activity {
...
//                startActivity(intent);
        ...
        //Tab 2
        spec = host.newTabSpec("substância branca");
        spec.setContent(R.id.tab2);
        spec.setIndicator("substância branca");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("substância cinza");
        spec.setContent(R.id.tab3);
        spec.setIndicator("substância cinza");
        host.addTab(spec);

        //Tab 4
        spec = host.newTabSpec("neurônio");
