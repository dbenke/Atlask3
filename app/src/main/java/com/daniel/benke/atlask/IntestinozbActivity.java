...
public class IntestinozbActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intestinozb);
...
//                startActivity(intent);
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="zoom 1") {
                    ...
                    Intent nextScreen = new Intent(getApplicationContext(), MedulaActivity.class);
        ...
        //Tab 6
        spec = host.newTabSpec("linfático");
        spec.setContent(R.id.tab6);
        spec.setIndicator("linfático");
        host.addTab(spec);

        //Tab 7
        spec = host.newTabSpec("Lieberkuhn");
        spec.setContent(R.id.tab7);
        spec.setIndicator("Lieberkuhn");
        host.addTab(spec);
