...
public class IntestinoZ1Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intestinoz1);
...
//                startActivity(intent);
        ...
        //Tab 4
        spec = host.newTabSpec("caliciforme");
        spec.setContent(R.id.tab4);
        spec.setIndicator("caliciforme");
        host.addTab(spec);

        //Tab 5
        spec = host.newTabSpec("vilo");
        spec.setContent(R.id.tab5);
        spec.setIndicator("vilo");
        host.addTab(spec);
